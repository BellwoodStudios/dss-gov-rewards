...
contract DssGovRewards {
    ...
    constructor(
        ...
        stakingToken = TokenLike(_stakingToken);
    ...
    function stake(uint256 amount) external nonReentrant updateReward(msg.sender) {
        require(amount > 0, "DssGovRewards/cannot-stake-0");
    ...
    function notifyRewardAmount(uint256 reward) external auth updateReward(address(0)) {
        ...
        require(rewardRate <= balance.div(rewardsDuration), "DssGovRewards/provided-amount-too-high");
    ...
    modifier nonReentrant {
        require(locked == 1, "DssGovRewards/reentrancy-guard");
        locked = 2;
        _;
        locked = 1;
    }
